					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="1.Tabla de empleados.hmtl" class="nav-link active">Tabla de empleados</a></li>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><span class="font-weight-semibold">Editar empleados</span></h4>
			...
			<!-- Content area -->
				<div class="form-group row">
									<label class="col-form-label col-lg-2">Edicion de trabajadores</label>
									<div class="col-lg-10">
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Nombre</label>
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">Marco</option>
			                               <option value="opt2">Lucina</option>
			                               <option value="opt3">Aurora</option>
			                               <option value="opt4">Pedro</option>
			                               <option value="opt5">Daniel</option>
			                           </select>
		                            </div>
		                        </div>				                       
		                        <div class="form-group row">
		                        	...
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">Hernandez</option>
			                               <option value="opt2">Cepeda</option>
			                               <option value="opt3">Gomez</option>
			                               <option value="opt4">Navarro</option>
			                               <option value="opt5">Gomez</option>
			                           </select>
		                            </div>
		                        </div>				                        
		                        <div class="form-group row">
		                        	...
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">Perez</option>
			                               <option value="opt2">Perez</option>
			                               <option value="opt3">Guzman</option>
			                               <option value="opt4">Navarro</option>
			                               <option value="opt5">Gomez</option>
			                           </select>
		                            </div>
		                        ...
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Nombre del usuario</label>
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">marcohrp95</option>
			                               <option value="opt2">lucinacpe</option>
			                               <option value="opt3">auroragmz</option>
			                               <option value="opt4">linaresped</option>
			                               <option value="opt5">danizago</option>
			                           </select>
		                            </div>
		                        </div>				                       
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Id de usuario</label>
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">12738</option>
			                               <option value="opt2">12739</option>
			                               <option value="opt3">12729</option>
			                               <option value="opt4">12764</option>
			                               <option value="opt5">12798</option>
			                           </select>
		                            </div>
		                        </div>													
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Area de trabajo</label>
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1"></option>
			                               <option value="opt2">Administración</option>
			                               <option value="opt3">Contabilidad</option>
			                               <option value="opt4">Limpieza</option>
			                               <option value="opt5">Programación</option>
			                           </select>
		                            </div>
		                        </div>								
		                        <div class="form-group row">
		                        	...
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">marco67@gmail.com</option>
			                               <option value="opt2">lucina09@outlook.com</option>
			                               <option value="opt3">auroragmz12@gmail.com</option>
			                               <option value="opt4">pdronava_21@hotmail.com</option>
			                               <option value="opt5">zavago_12@outlook.com</option>
			                           </select>
		                            </div>
		                        </div>		
											</div>	
