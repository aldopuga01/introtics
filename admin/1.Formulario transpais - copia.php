		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><span class="font-weight-semibold">Registro transpais</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_basic.php" class="breadcrumb-item">Transpais</a>
			...
			<div class="content">
				...
				<div class="form-group row">
									<label class="col-form-label col-lg-2">Registro de alumno</label>
									<div class="col-lg-10">
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Matricula">
												</div>												
												<div class="form-group">
		                      	...
		                      	<div class="form-group row">
		                        	...
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">Escoga una opción</option>
			                               <option value="opt2">Tecnologias de la información</option>
			                               <option value="opt3">Mecatronica</option>
			                               <option value="opt4">Manufactura</option>			                     <option value="opt5">Sistemas automotrices</option>                       <option value="opt6">Layge</option>
			                           </select>
		                            </div>
		                        </div>										
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Fecha de pago">	
												</div>
		                      	<div class="form-group row">
		                        	...
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">Escoga una opción</option>
			                               <option value="opt2">Libertad</option>
			                               <option value="opt3">Tamatán</option>
			                           </select>
		                            </div>
		                        </div>								
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Horario">
												</div>
				<!-- Vertical borders --
				<div class="card">
					<div class="card-header header-elements-inline">
