	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><span class="font-weight-semibold">Tabla de empresas</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_basic.php" class="breadcrumb-item">Empresas</a>
							<span class="breadcrumb-item active">Tabla de empresas</span>
						</div>
			...
			<div class="content">
					...
					<table class="table table-dark bg-blue">
						<thead>
							<tr class="bg-grey">
						...
						<tbody>
							<tr>
								...
								<td>87030</td>
								<td>253-312-5378</td>
								<td>sams_empresa@outlook.com</td>
								<td>1</td>
								<td>Calle Coahuila</td>
								<td>Fidel Velázquez Sanchez</td>
								<td>9:00 hrs- 20:00 hrs</td>
							...
							<tr>
								<td>Walmart adelitas</td>
								<td>87030</td>
								<td>253-312-5321</td>
								<td>walmart_empresa@outlook.com</td>
								<td>2</td>
								<td>Calle Coahuila</td>
								<td>Fidel Velázquez Sanchez</td>
							...
							<tr>
								<td>Soriana Tamatan</td>
								<td>87070</td>
								<td>253-312-5213</td>
								<td>sorianas_empresa@outlook.com</td>
								<td>6</td>
								<td>Calz Gral Luis Caballero </td>
								<td>Zozaya</td>
							...
							<tr>
								<td>Grand Libertad</td>
								<td>87015</td>
								<td>253-142-5642</td>
								<td>grand_libertad@outlook.com</td>
								<td>8</td>
								<td>Gral Lazaro Cardenas Eje vial</td>
								<td>Gral Lazaro Cardenas Eje vial</td>
								<td>7:00 hrs- 22:00 hrs</td>
								<td class="text-center">
										<div class="list-icons">
							...
							<tr>
								...
								<td>87000</td>
								<td>235-453-9834</td>
								<td>cuidadoconel@outlook.com</td>
								<td>1</td>
								<td>Calle Hidalgo</td>
								<td>Zona centro</td>
								<td>10:00 hrs - 8:00 hrs</td>
								<td class="text-center">
										<div class="list-icons">
					                		<a href="#" class="list-icons-item text-primary-600"><i class="icon-pencil7"></i></a>
					                		<a href="#" class="list-icons-item text-danger-600"><i class="icon-trash"></i></a>
