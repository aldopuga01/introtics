		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><span class="font-weight-semibold">Añadir vacaciones</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_basic.php" class="breadcrumb-item">Vacaciones</a>
			...
			<!-- Content area -->
				<div class="form-group row">
									<label class="col-form-label col-lg-2">Registro de vacaciones</label>
									<div class="col-lg-10">
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Nombre/s">
												</div>												
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Mes que lo solicita">
												</div>													
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Dias solicitados</label>
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1"></option>
			                               <option value="opt2">5-10 dias</option>
			                          ...
			                          <button type="submit" class="btn btn primary ml-3">Solicitar vacaciones<i class="icon-paperplane ml-2"></i></button>
		                            </div>
									</div>
									</div>	
									</div>		
