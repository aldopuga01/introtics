		...
		<div class="content-wrapper">
			...
			<!-- Content area -->
				<div class="form-group row">
									<label class="col-form-label col-lg-2">Registro de empresa</label>
									<div class="col-lg-10">
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Nombre de la sucursal">
												</div>												
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Nombre">
												</div>	
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Codigo postal">
												</div>												
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Telefono">
												</div>												
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Correo">
												</div>
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Calle">
												</div>			
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Colonia">
												</div>										
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Hora de apertura</label>
		                        	<div class="col-lg-3">
			                           <select class="custom-select">
			                               <option value="opt1"></option>
			                               <option value="opt2">07:00 hrs</option>
			                               <option value="opt3">08:00 hrs</option>
			                               <option value="opt4">09:00 hrs</option>
			                               <option value="opt5">10:00 hrs</option>
			                           </select>
		                            </div>
		                        </div>						
		                            <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Hora de cierre</label>
		                        	<div class="col-lg-3">
			                           <select class="custom-select">
			                               <option value="opt1"></option>
			                               <option value="opt2">20:00 hrs</option>
			                               <option value="opt3">21:00 hrs</option>
			                               <option value="opt4">22:00 hrs</option>
			                               <option value="opt5">23:00 hrs</option>
			                           </select>
			                        <div>
