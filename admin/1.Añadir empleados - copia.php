		...
		<div class="content-wrapper">
			...
			<!-- Content area -->
				<div class="form-group row">
									<label class="col-form-label col-lg-2">Registro de trabajador</label>
									<div class="col-lg-10">
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Nombre/s">
												</div>												
												<div class="form-group">
												...
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Nombre de usuario">
												</div>												
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Numero de cuenta">
												</div>
												<div class="form-group">
													<input class="form-control form-control-sm" type="text" placeholder="Numero de telefono">
												</div>												
		                        <div class="form-group row">
								    ...
								    <div class="form-group">
									<input class="form-control form-control-sm" type="text" placeholder="Correo electronico">
								    <div>
			                          <button type="submit" class="btn btn primary ml-3">Añadir empleado<i class="icon-paperplane ml-2"></i></button>
		                            </div>
									</div>
									</div>	
									</div>		
