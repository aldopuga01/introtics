		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><span class="font-weight-semibold">Editar departamentos</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_basic.php" class="breadcrumb-item">Departamentos</a>
			...
			<!-- Content area -->
				<div class="form-group row">
									<label class="col-form-label col-lg-2">Edicion de departamentos</label>
									<div class="col-lg-10">
		                        <div class="form-group row">
		                       	...
		                       	<div class="form-group row">
									<label class="col-form-label col-lg-2">Numero de empleados</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="1,2,3...15">
									</div>
								</div>		                        
		                       	<div class="form-group row">
									<label class="col-form-label col-lg-2">Código del departamento</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="241-453">
									</div>
								</div>	                        
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Encargado del departamento</label>
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">Jose Perez</option>
			                               <option value="opt2">Jason Martinez</option>
			                               <option value="opt3">Aurora Gomez</option>
			                               <option value="opt4">Marco Hernandez</option>
			                           </select>
		                            </div>
		                        </div>				                       		
							</div>					
