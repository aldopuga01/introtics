	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><span class="font-weight-semibold">Tabla de departamentos</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Tabla de departamentos</span>
						</div>
			...
			<div class="content">
					...
					<table class="table table-dark bg-orange">
						<thead>
							<tr class="bg-green">
								<th>Nombre del departamento</th>
								<th>Numero de empleados</th>
								<th>Código del departamento</th>
								<th>Encargado del departamento</th>
