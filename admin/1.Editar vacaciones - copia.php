		...
		<div class="content-wrapper">
			...
			<!-- Content area -->
				<div class="form-group row">
									<label class="col-form-label col-lg-2">Edicion de vacaciones</label>
									<div class="col-lg-10">
		                        <div class="form-group row">
		                        ...
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Solicitar</label>
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
			                               <option value="opt1">Solicitar</option>
			                               <option value="opt2">No solicitar</option>
			                           </select>
		                            </div>
		                        </div>				                        
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Cantidad de dias</label>
		                        	<div class="col-lg-4">
			                           <select class="custom-select">
			                               <option value="opt1">1-5 dias</option>
			                               <option value="opt2">1-10 dias</option>
			                               <option value="opt3">10-15 dias</option>
			                               <option value="opt4">15-20 dias</option>
			                               <option value="opt5">20-25 dias</option>
			                           </select>
		                            </div>
		                        </div>			
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Mes</label>
		                        	<div class="col-lg-4">
			                           <select class="custom-select">
			                               <option value="opt1">Julio</option>
			                               <option value="opt2">Junio</option>
			                               <option value="opt3">Enero</option>
			                               <option value="opt4">Diciembre</option>
			                           </select>
		                            </div>
		                        </div>			                        
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Aceptadas</label>
		                        	<div class="col-lg-10">
			                           <select class="custom-select">
										   <option value="opt1"></option>
			                               <option value="opt2">Denegadas</option>
			                               <option value="opt3">Aceptadas</option>
			                           </select>
		                            </div>
		                        </div>				                       		
							</div>					
